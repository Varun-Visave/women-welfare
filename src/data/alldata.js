...
const allData = [
  ...
  {
    id: 3,
    title: "Regional Committees & Workshops :- Nagpur-Region",
    description:
      "Gadchiroli District\nChurning of Thoughts: On Women's Issues\nOrganizer: Coordination Committee, Gadchiroli District, Maharashtra Stree Mukti Parishad\nChief Guest: Mrs. Sumati Munghate, Senior Social Worker, Gadchiroli\nDate: 19th August 2025, Time: 11 AM to 4 PM\nIn 1975, the UN declared International Women's Year, followed by the Women's Decade. During this period, many new laws and schemes related to women were introduced in Maharashtra and across the country. Many changes took place. A women's policy was introduced. For the implementation of this policy, various committees, departments, and increasing participation of women in local self-government institutions led to the involvement of many women. Along with this, organizations that voiced women's issues also emerged. In 2025, it has been 50 years since these efforts began. On this occasion, women should come forward to present their issues and engage in a churning of thoughts (discussion).",
  image: "Nagpur meeting.png",
  date: "Aug 19, 2025",
  },
  {
    id: 4,
  ...
  image: "Dharashiv Busstand safety Audit.png",
  date: "Oct 2025",
  },
  {
    id: 6,
  ...
  {
    id: 10,
    title: "Regional Committees & Workshops :- Amaravati and Marathwada region",
    description:
      "Amarawati, Akola, Yawatmal, Washim, Buldhana,Dharashiv, Latur, Beed, Parbhani, Hingoli, Jalana, Nanded,Chhatrapati Sambhaji Nagar(Aurangabad)",
      image: "Parbhani 8th march prog.png",
      date: "Mar 8, 2025",
  },
  {
    id: 11,
    title: "Regional Committees & Workshops :- Khandesh and Kokan region",
    description:
      "Nashik, Dhule, Jalgaon, Nandurbar ,Mumbai, Thane, Palghar, Navi Mumbai, Raigad, Ratnagiri, Sindhudurg",
    image: "Kolhapur team.png",
    date: "2025",
  },
];
